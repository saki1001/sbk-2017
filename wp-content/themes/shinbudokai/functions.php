<?php
/**
 * shinbudokai functions and definitions
 *
...
if ( ! function_exists( 'shinbudokai_setup' ) ) :
/**
 ...
 */
function shinbudokai_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on shinbudokai, use a find and replace
	 * to change 'shinbudokai' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'shinbudokai', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'header' => esc_html__( 'Primary Menu', 'shinbudokai' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'shinbudokai_custom_background_args', array(
...
add_action( 'after_setup_theme', 'shinbudokai_setup' );
 ...
 */
function shinbudokai_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'shinbudokai_content_width', 640 );
}
add_action( 'after_setup_theme', 'shinbudokai_content_width', 0 );
 ...
 */
function shinbudokai_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'shinbudokai' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'shinbudokai' ),
...
add_action( 'widgets_init', 'shinbudokai_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function shinbudokai_scripts() {
